...
void noSuchCom()
{
	...
	printf("      #   +  +  +   +     +   +    +      Sorry                          #\n");
	printf("      #   +         + + + +      + +                                     #\n");
	printf("      #   0            +           +      There's no such command        #\n");
	printf("      #       + + + + + + + + + +  0                                     #\n");
	printf("      #        + + + + + + + + +          You can get more information   #\n");
	printf("      #         + + + + + + + +                                          #\n");
	printf("      #                                   by inputting [help]            #\n");
	printf("      #                                                                  #\n");
	printf("      #                                                                  #\n");
	printf("      #                                                                  #\n");
	printf("      #       ######   #    #      #      #  #   ######   ######         #\n");
...
void commandList()
{
	...
	printf("      # 0            +           +  $ process --- process manager        #\n");
	printf("      #     + + + + + + + + + +  0  $ file --- file manager              #\n");
	printf("      #      + + + + + + + + +      $ game --- 5 games                   #\n");
	...
	printf("      #     # #  # #   # # #  #  #  $ sleep ---put the computer to sleep #\n");
	printf("      #  #### #  # #   # #  # ####                                       #\n");
	printf("      #                       TONGJI UNIVERSITY                          #\n");
	printf("      ====================================================================\n");
	printf("\n\n");
